from todo_app_cli.functions import get_date, get_todos, write_todos
from todo_app_cli.functions import FILE_PATH, WARNING_MESSAGE_1, \
    WARNING_MESSAGE_2
import colorama
...
if __name__ == '__main__':
    # Show current date
    print(f'{Fore.WHITE}##############################################\n'
          f'{Fore.CYAN}Date: {functions.get_date()}\n'
          f'{Fore.WHITE}##############################################\n')
    while True:
        ...
        if user_action.startswith('add') or user_action.startswith('new'):
            ...
            try:
                ...
                # Write todo list
                functions.write_todos(file_path=FILE_PATH, todos_arg=todos)
